  ...
  <div class="auth-brand">
    <div class="auth-brand-logo">
      <svg width="64" height="64" viewBox="0 0 42 42" fill="none">
        <defs><linearGradient id="alg2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#FF8A00"/><stop offset="50%" stop-color="#F72585"/>
          <stop offset="100%" stop-color="#2E8B57"/>
        </linearGradient></defs>
        <path d="M21 36s-1.5-1.2-4-3.3C10.5 27.4 5 22.5 5 16.5A8.5 8.5 0 0121 11a8.5 8.5 0 0116 5c0 6-5.5 10.9-12 16.2-2.5 2.1-4 3.3-4 3.3z" fill="url(#alg2)"/>
